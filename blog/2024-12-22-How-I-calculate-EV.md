---
title: How I calculate expected value
authors: grate
...
Expected value is a common way to assess choices whilst including probability, in my personal life I use a slightly modified (and exhaustive) version that I think yields better results. <!-- truncate -->
$$
E(X) = \sum_{i=1}^{n} x_i \cdot P(x_i)
$$
Above is the common formula for EV, below I'll include an example
...
$$
EV = \sum_{i=1}^{n} P_i \cdot (AV_i + SV_i + LV_i)
$$
...
$$
EV = \sum_{i=1}^{n} P_i \cdot \left( W_a \cdot AV_i + W_s \cdot SV_i + W_l \cdot LV_i \right)
$$
